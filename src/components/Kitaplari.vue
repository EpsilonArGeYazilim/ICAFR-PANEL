<template>
  <div>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-dashboard"></i>Kitapları</h1>
        </div>
...
export default {
  ...
  created() {
    let dataUrl =
      store.state.base_url + "Page/getPage.php?key=123&page_number=7&lan_id=1";
  ...
  methods: {
    ...
    onChange(event) {
      ...
      let dataUrl =
        ...
        "Page/getPage.php?key=123&page_number=7&lan_id=" +
        this.language_id;
